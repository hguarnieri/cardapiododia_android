...
import com.hguarnieri.cardapiododia.utils.Schedules;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.main_screen_leaves_central_building_text)).setText("- " + Schedules.getNextTime(0));
        ((TextView) findViewById(R.id.main_screen_main_gate_text)).setText("- " + Schedules.getNextTime(1));
        ((TextView) findViewById(R.id.main_screen_arrives_central_building_text)).setText("- " + Schedules.getNextTime(2));
